...
| Talos control-plane IP | `192.168.1.178` |
...
- Harvester VIP/UI `192.168.1.50` is the shared UI/API access point. Each physical Harvester node still needs its own management IP for node-level operations and monitoring.
